...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        var sdk = TMSDK()
        sdk.config(programId: "0e60f6a1b71311ec9e1cc968ca9ce661", appid: "tm035dc36fbbad5d36", channel: "test")
//        print(sdk.captcha(phone: "13535032936"))//获取验证码
//        print(sdk.login(phone: "13535032936", verify_code: "204689"))//登录
...
//        print(sdk.identify(open_id: "xh381qMrBoZchznT2Gjvm9_h5", name: "黄焕来", id_card: "452122199308195458"))//实名
